window.registerPrototypePage({
  ...
  productDoc: {
    title: "本地视频需求说明",
    summary: "面向研发、设计、测试说明本地素材管理页的原型范围。",
    goal: "供运营人员统一管理本地上传的图片和视频素材，重点支持新增、预览和删除素材记录。",
    modules: [
      "顶部工具栏提供添加和批量删除操作，承接素材台账维护入口。",
      "筛选区支持按关键字和文件类型快速定位目标记录。",
      "列表集中展示记录名称、文件类型、文件数量、备注、创建时间和行内操作。",
      "新增弹窗和预览弹窗分别用于录入本地素材信息和查看素材内容。"
    ],
    rules: [
      "列表页以素材台账管理为主，不在当前页直接承接离线分析任务配置。",
      "图片和视频共用同一列表结构，但预览内容和文件类型状态需要区分表达。",
      "新增记录后需要同步生成对应预览内容，删除后同步移除。"
    ],
    interactions: [
      "点击添加可打开新增弹窗，并在保存后更新列表。",
      "点击预览可打开对应素材预览弹窗。",
      "批量删除仅对当前勾选项生效。",
      "筛选条件变化后，列表结果需要正确刷新。"
    ]
